...
parser.add_argument('--dataset_dir', default='dataset/raw_ac.py', help='Path to dataset')
parser.add_argument('--pathway_dir', default='dataset/pathway_kegg.py' , help='Path to pathway dataset')
parser.add_argument('--drug_ids_path', default='dataset/drugs_ids_approved_mysql_on_onecc_noiso_string_dense.hkl', help='Path to drug ids')
...
parser.add_argument('--splits_path', default='dataset/5foldCVsplits/', help='Path to splits')
